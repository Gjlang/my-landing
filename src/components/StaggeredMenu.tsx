  ...
  return (
    <div className="sm-scope w-full h-full">
      <div
        ...
        style={
          accentColor
            ? ({ "--sm-accent": accentColor } as StyleWithVars)
            : undefined
        }
...
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after {
  ...
  position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400;
  color: var(--sm-accent, #ff0000); letter-spacing: 0; pointer-events: none; user-select: none;
