...
const CardNav: React.FC<CardNavProps> = ({
  ...
  const calculateHeight = () => {
    ...
    if (isMobile) {
      ...
      if (contentEl) {
        ...
        // force reflow (mark as used expression)
  ...
  // Stable timeline creator (for lint: deps OK)
  ...
  return (
    <div
      className={`card-nav-container fixed left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] z-[99] top-6 md:top-10 ${className}`}
    >
      <nav
        ref={navRef}
